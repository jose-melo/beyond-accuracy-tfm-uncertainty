...
class Method(object, metaclass=abc.ABCMeta):
    ...
    def data_format(self, is_train=True, N=None, C=None, y=None):
        ...
        if is_train:
            ...
            y_test = {"test": np.zeros(len(N_test["test"]))}  # dummy labels
    ...
    def metric(self, predictions, labels, y_info):
        ...
        if self.is_regression:
            ...
            auc = (
                skm.roc_auc_score(labels, predictions[:, 1], labels=y_info["classes"])
            ...
            if len(present_classes) < 2:
                ...
                class_indices = [
                    i for i, c in enumerate(y_info["classes"]) if c in present_classes
                ]
