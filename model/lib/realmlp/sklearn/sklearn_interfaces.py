...
from model.lib.realmlp.sklearn.sklearn_base import (
...
class RealMLPConstructorMixin:
    def __init__(
        ...
        tmp_folder: Optional[Union[str, pathlib.Path]] = None,
        verbosity: int = 0,
        ...
        use_plr_embeddings: Optional[bool] = None,
        plr_sigma: Optional[float] = None,
        plr_hidden_1: Optional[int] = None,
        plr_hidden_2: Optional[int] = None,
        plr_act_name: Optional[str] = None,
        plr_use_densenet: Optional[bool] = None,
        plr_use_cos_bias: Optional[bool] = None,
        plr_lr_factor: Optional[float] = None,
        max_one_hot_cat_size: Optional[int] = None,
        embedding_size: Optional[int] = None,
        act: Optional[str] = None,
        use_parametric_act: Optional[bool] = None,
        act_lr_factor: Optional[float] = None,
        weight_param: Optional[str] = None,
        weight_init_mode: Optional[str] = None,
        weight_init_gain: Optional[str] = None,
        weight_lr_factor: Optional[float] = None,
        bias_init_mode: Optional[str] = None,
        ...
        p_drop_sched: Optional[str] = None,
        wd: Optional[float] = None,
        wd_sched: Optional[str] = None,
        opt: Optional[str] = None,
        lr: Optional[Union[float, Dict[str, float]]] = None,
        lr_sched: Optional[str] = None,
        mom: Optional[float] = None,
        mom_sched: Optional[str] = None,
        sq_mom: Optional[float] = None,
        sq_mom_sched: Optional[str] = None,
        opt_eps: Optional[float] = None,
        opt_eps_sched: Optional[str] = None,
        normalize_output: Optional[bool] = None,
        clamp_output: Optional[bool] = None,
        use_ls: Optional[bool] = None,
        ls_eps: Optional[float] = None,
        ls_eps_sched: Optional[float] = None,
        ...
        * For classification, if you care about metrics like cross-entropy or AUC instead of accuracy,
        ...
        self.early_stopping_multiplicative_patience = (
